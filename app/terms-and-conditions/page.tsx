    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none text-justify">
        ...
        <ol className="pl-6 space-y-4">
          ...
          <li>
            ...
            <ol className="list-lower-alpha pl-6 space-y-2">
              ...
              <li>
                download and store the Content in electronic form on a disk (but
                not on any server or other storage device connected to a
                network)
              </li>
            </ol>
          </li>
        ...
        <h3 className="text-2xl font-semibold mt-6 mb-3">Prohibited use</h3>
          <ul>
            <li className="mb-4">4. You may not use the Website for any of the following purposes:</li>
            <li>
        ...
        <ul className=" pl-6 space-y-4">
          <li>
            1. You must ensure that the details provided by you on registration or
            at any time are correct and complete.
          </li>
          <li>
            2. You must inform us immediately of any changes to the information
          ...
          <li>
            4. You may cancel your registration at any time by informing us in
        ...
        <ol className="pl-6 space-y-4">
          ...
          <li>
            10. If we have reason to believe that there is or is likely to be any
        ...
        <ol className="pl-6 space-y-4">
          <li>
            15. Any online facilities, tools, services or information that Vellio
            Properties Ltd makes available through the Website (the{" "}
          ...
          <li>
            16. Whilst Vellio Properties Ltd uses reasonable endeavours to ensure
            that the Website is secure and free of errors, viruses and other
            malware, we give no warranty or guaranty in that regard and all
        ...
        <ol className="pl-6 space-y-4">
          <li>
            19. Nothing in these terms and conditions will: (a) limit or exclude our
          ...
          <li>
            21. We will not be liable to you in respect of any losses arising out of
        ...
        <ol className="pl-6 space-y-4">
          ...
          <li>
            24. These terms and conditions may be varied by us from time to time.
          ...
          <li>
            26. The Contracts (Rights of Third Parties) Act 1999 shall not apply to
          ...
          <li>
            29. This Agreement shall be governed by and interpreted according to the
        ...
        <p>
          30. Vellio Properties Ltd is a company incorporated in England and Wales
          with registered number 16033278 whose registered address is 53 Rodney
          Crescent, Filton, Bristol BS34 7AF, United Kingdom and it operates the
          Website vellioproperties.com.
        </p>
        <p>
        ...
        <p className="font-bold">Please read all these terms and conditions.</p><br />
        <p>
          31. As we can accept your order and make a legally enforceable agreement
        ...
        <ol className="pl-6 space-y-4">
          <li>
            1. These Terms and Conditions will apply to the purchase of the goods
            by you (the <strong>Customer</strong> or <strong>you</strong>). We
            are Vellio Properties Ltd a company registered in England and Wales
            under number 16033278 whose registered office is at 53 Rodney
          ...
          <li>
            2. These are the terms on which we sell all Goods to you. By ordering
            any of the Goods, you agree to be bound by these Terms and
        ...
        <ol className="pl-6 space-y-4">
          ...
          <li>
            <strong>5. Delivery Location</strong> means the Supplier's premises or
            other location where the Goods are to be supplied, as set out in the
            Order;
          </li>
          <li>
            <strong>6. Durable Medium</strong> means paper or email, or any other
            ...
            accessible for future reference for a period that is long enough for
          ...
          <li>
            <strong>8. Order</strong> means the Customer's order for the Goods from
            the Supplier as submitted following the step by step process set out
            on the Website;
          </li>
          <li>
            <strong>9. Privacy Policy</strong> means the terms which set out how we
            will deal with confidential and personal information received from
            you via the Website;
          </li>
          <li>
            <strong>10. Website</strong> means our website vellioproperties.com on
        ...
        <ol className="pl-6 space-y-4">
          ...
          <li>
            12. In the case of any Goods made to your special requirements, it is
            your responsibility to ensure that any information or specification
          ...
          <li>
            14. We can make changes to the Goods which are necessary to comply with
            any applicable law or safety requirement. We will notify you of
            these changes.
          </li>
        </ol>
        ...
        <ol className="pl-6 space-y-4">
          <li>
            15. When registering to use the Website you must set up a username and
          ...
          <li>
            17. We may contact you by using e-mail or other electronic communication
        ...
        <ol className="pl-6 space-y-4">
          <li>
            18. The description of the Goods in our website does not constitute a
            contractual offer to sell the Goods. When an Order has been
            submitted on the Website, we can reject it for any reason, although
            we will try to tell you the reason without delay.
          </li>
          <li>
            19. The Order process is set out on the Website. Each step allows you to
          ...
          <li>
            20. A Contract will be formed for the sale of Goods ordered only when
          ...
          <li>
            23. We intend that these Terms and Conditions apply only to a Contract
            entered into by you as a Consumer. If this is not the case, you must
            tell us, so that we can provide you with a different contract with
            terms which are more appropriate for you and which might, in some
        ...
        <ol className="pl-6 space-y-4">
          <li>
            24. The price of the Goods and any additional delivery or other charges
            is that set out on the Website at the date of the Order or such
            other price as we may agree in writing.
          </li>
          <li>
            25. Prices and charges include VAT at the rate applicable at the time of
            the Order.
          </li>
          <li>
            26. You must pay by submitting your credit or debit card details with
        ...
        <ol className="pl-6 space-y-4">
          <li>
            27. We will deliver the Goods, to the Delivery Location by the time or
            within the agreed period or, failing any agreement, without undue
            delay and, in any event, not more than 30 days after the day on
            which the Contract is entered into.
          </li>
          <li>
            28. In any case, regardless of events beyond our control, if we do not
            ...
            <ol className="list-lower-alpha pl-6 space-y-2">
              <li>
                ...
                the time the Contract was made, or you said to us before the
          ...
          <li>
            29. If you treat the Contract at an end, we will (in addition to other
            remedies) promptly return all payments made under the Contract.
          </li>
          <li>
            30. If you were entitled to treat the Contract at an end, but do not do
            so, you are not prevented from cancelling the Order for any Goods or
            rejecting Goods that have been delivered and, if you do this, we
          ...
          <li>
            31. If any Goods form a commercial unit (a unit is a commercial unit if
            division of the unit would materially impair the value of the goods
            or the character of the unit) you cannot cancel or reject the Order
            for some of those Goods without also cancelling or rejecting the
            Order for the rest of them.
          </li>
          <li>
            32. We do not generally deliver to addresses outside England and Wales,
            Scotland, Northern Ireland, the Isle of Man and Channels Islands.
            If, however, we accept an Order for delivery outside that area, you
            may need to pay import duties or other taxes, as we will not pay
            them.
          </li>
          <li>
        ...
        <ol className="pl-6 space-y-4">
          <li>
            36. Risk of damage to, or loss of, any Goods will pass to you when the
            Goods are delivered to you.
          </li>
          <li>
            37. You do not own the Goods until we have received payment in full. If
        ...
        <ol className="pl-6 space-y-4">
          ...
          <li>
            ...
            <ol className="list-lower-alpha pl-6 space-y-2">
              ...
              <li>b. goods which are liable to deteriorate or expire rapidly.</li>
            </ol>
          </li>
          <li>
        ...
        <ol className="pl-6 space-y-4" start={41}>
          <li>
            41. Subject as stated in these Terms and Conditions, you can cancel this
            contract within 14 days without giving any reason.
          </li>
          <li>
            42. The cancellation period will expire after 14 days from the day on
          ...
          <li>
            43. To exercise the right to cancel, you must inform us of your decision
            to cancel this Contract by a clear statement setting out your
            decision (eg a letter sent by post, fax or email). You can use the
            attached model cancellation form, but it is not obligatory. In any
            event, you must be able to show clear evidence of when the
          ...
          <li>
            45. To meet the cancellation deadline, it is sufficient for you to send
        ...
        <ol className="pl-6 space-y-4" start={47}>
          <li>
            47. We may make a deduction from the reimbursement for loss in value of
        ...
        <ol className="pl-6 space-y-4" start={48}>
          <li>
            ...
            <ol className="list-lower-alpha pl-6 space-y-2">
              ...
              <li>
                b. (if earlier) 14 days after the day you provide evidence that you
          ...
          <li>
            50. We will make the reimbursement using the same means of payment as
        ...
        <ol className="pl-6 space-y-4" start={51}>
          <li>
            51. If you have received Goods in connection with the Contract which you
            have cancelled, you must send back the Goods or hand them over to us
            at 53 Rodney Crescent, Filton, Bristol BS34 7AF, United Kingdom
            without delay and in any event not later than 14 days from the day
            on which you communicate to us your cancellation of this Contract.
            The deadline is met if you send back the Goods before the period of
            14 days has expired. You agree that you will have to bear the cost
            of returning the Goods.
          </li>
          <li>
            52. For the purposes of these Cancellation Rights, these words have the
            following meanings:
            <ol className="list-lower-alpha pl-6 space-y-2">
              <li>
              ...
              <li>
                <strong>b. sales contract</strong> means a contract under which a
        ...
        <ol className="pl-6 space-y-4" start={53}>
          ...
          <li>
            ...
            <ol className="list-lower-alpha pl-6 space-y-2">
              ...
              <li>
                b. be reasonably fit for any particular purpose for which you buy
                the Goods which, before the Contract is made, you made known to
                us (unless you do not actually rely, or it is unreasonable for
                you to rely, on our skill and judgment) and be fit for any
          ...
          <li>
            55. It is not a failure to conform if the failure has its origin in your
            materials.
          </li>
          <li>
            56. We will provide the following after-sales service: The supplier will
            support the customer in installing and activating their new
        ...
        <ol className="pl-6 space-y-4" start={57}>
          <li>
            57. Either party can transfer the benefit of this Contract to someone
            else, and will remain liable to the other for its obligations under
            the Contract. The Supplier will be liable for the acts of any
        ...
        <ol className="pl-6 space-y-4" start={58}>
          <li>
            58. In the event of any failure by a party because of something beyond
        ...
        <ol className="pl-6 space-y-4" start={59}>
          <li>
            59. Your privacy is critical to us. We respect your privacy and comply
          ...
          <li>62. We are a Data Controller of the Personal Data we Process in providing Goods to you.</li>
          <li>
            63. Where you supply Personal Data to us so we can provide Goods to you,
            and we Process that Personal Data in the course of providing the
            Goods to you, we will comply with our obligations imposed by the
        ...
        <ol className="pl-6 space-y-4" start={65}>
          <li>
            65. The Supplier does not exclude liability for: (i) any fraudulent act
            or omission; or (ii) for death or personal injury caused by
        ...
        <ol className="pl-6 space-y-4" start={66}>
          <li>
            66. The Contract (including any non-contractual matters) is governed by
